...
public class frmAdduser extends javax.swing.JFrame {
    ...
    public frmAdduser(UserModel um) {
        initComponents();
        usermodel = um;
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try
        {
            ...
            UserModel umadd = new UserModel(firstname,lastname,username,password,userlevel);
        ...
        {
            JOptionPane.showMessageDialog(this, "Error add record: " + ex.toString());
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        //JOptionPane.showMessageDialog(this, usermodel.getUserlevel());
